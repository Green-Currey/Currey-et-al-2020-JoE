...
mod.nd <- summary(lmer(slnP ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
...
mod.dc <- summary(lmer(slnPdc~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(slnP ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.fix.nd.sp$upr[1] <- CI.nd[7,2]
line.range.plot.fix.nd.sp$upr[2] <- CI.nd[10,2] + CI.nd[7,2]
line.range.plot.fix.nd.sp$upr[3] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.fix.nd.sp$lwr[1] <- CI.nd[7,1]
line.range.plot.fix.nd.sp$lwr[2] <- CI.nd[10,1] + CI.nd[7,1]
line.range.plot.fix.nd.sp$lwr[3] <- CI.nd[11,1] + CI.nd[7,1]

CI.dc <- confint(lmer(slnPdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.fix.dc.sp$upr[1] <- CI.dc[6,2]
line.range.plot.fix.dc.sp$upr[2] <- CI.dc[9,2] + CI.dc[6,2]
line.range.plot.fix.dc.sp$upr[3] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.fix.dc.sp$lwr[1] <- CI.dc[6,1]
line.range.plot.fix.dc.sp$lwr[2] <- CI.dc[9,1] + CI.dc[6,1]
line.range.plot.fix.dc.sp$lwr[3] <- CI.nd[11,1] + CI.nd[7,1]
...
mod.nd <- summary(lmer(sI ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
...
mod.dc <- summary(lmer(sIdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(sI ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.fix.nd.sp$upr[7] <- CI.nd[7,2]
line.range.plot.fix.nd.sp$upr[8] <- CI.nd[10,2] + CI.nd[7,2]
line.range.plot.fix.nd.sp$upr[9] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.fix.nd.sp$lwr[7] <- CI.nd[7,1]
line.range.plot.fix.nd.sp$lwr[8] <- CI.nd[10,1] + CI.nd[7,1]
line.range.plot.fix.nd.sp$lwr[9] <- CI.nd[11,1] + CI.nd[7,1]

CI.dc <- confint(lmer(sIdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.fix.dc.sp$upr[7] <- CI.dc[6,2]
line.range.plot.fix.dc.sp$upr[8] <- CI.dc[9,2] + CI.dc[6,2]
line.range.plot.fix.dc.sp$upr[9] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.fix.dc.sp$lwr[7] <- CI.dc[6,1]
line.range.plot.fix.dc.sp$lwr[8] <- CI.dc[9,1] + CI.dc[6,1]
line.range.plot.fix.dc.sp$lwr[9] <- CI.nd[11,1] + CI.nd[7,1]
...
mod.nd <- summary(lmer(slnM ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
...
mod.dc <- summary(lmer(slnMdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(slnM ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.fix.nd.sp$upr[4] <- CI.nd[7,2]
line.range.plot.fix.nd.sp$upr[5] <- CI.nd[10,2] + CI.nd[7,2]
line.range.plot.fix.nd.sp$upr[6] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.fix.nd.sp$lwr[4] <- CI.nd[7,1]
line.range.plot.fix.nd.sp$lwr[5] <- CI.nd[10,1] + CI.nd[7,1]
line.range.plot.fix.nd.sp$lwr[6] <- CI.nd[11,1] + CI.nd[7,1]

CI.dc <- confint(lmer(slnMdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.fix.dc.sp$upr[4] <- CI.dc[6,2]
line.range.plot.fix.dc.sp$upr[5] <- CI.dc[9,2] + CI.dc[6,2]
line.range.plot.fix.dc.sp$upr[6] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.fix.dc.sp$lwr[4] <- CI.dc[6,1]
line.range.plot.fix.dc.sp$lwr[5] <- CI.dc[9,1] + CI.dc[6,1]
line.range.plot.fix.dc.sp$lwr[6] <- CI.nd[11,1] + CI.nd[7,1]
...
CI.nd <- confint(lmer(slnP ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.non.nd.sp$upr[1] <- CI.nd[7,2]
line.range.plot.non.nd.sp$upr[2] <- CI.nd[10,2] + CI.nd[7,2]
line.range.plot.non.nd.sp$upr[3] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.non.nd.sp$lwr[1] <- CI.nd[7,1]
line.range.plot.non.nd.sp$lwr[2] <- CI.nd[10,1] + CI.nd[7,1]
line.range.plot.non.nd.sp$lwr[3] <- CI.nd[11,1] + CI.nd[7,1]

CI.dc <- confint(lmer(slnPdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.non.dc.sp$upr[1] <- CI.dc[6,2]
line.range.plot.non.dc.sp$upr[2] <- CI.dc[10,2] + CI.dc[6,2]
line.range.plot.non.dc.sp$upr[3] <- CI.dc[11,2] + CI.dc[6,2]
line.range.plot.non.dc.sp$lwr[1] <- CI.dc[6,1]
line.range.plot.non.dc.sp$lwr[2] <- CI.dc[10,1] + CI.dc[6,1]
line.range.plot.non.dc.sp$lwr[3] <- CI.dc[11,1] + CI.dc[6,1]
...
CI.nd <- confint(lmer(sI ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.non.nd.sp$upr[7] <- CI.nd[7,2]
line.range.plot.non.nd.sp$upr[8] <- CI.nd[10,2] + CI.nd[7,2]
line.range.plot.non.nd.sp$upr[9] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.non.nd.sp$lwr[7] <- CI.nd[7,1]
line.range.plot.non.nd.sp$lwr[8] <- CI.nd[10,1] + CI.nd[7,1]
line.range.plot.non.nd.sp$lwr[9] <- CI.nd[11,1] + CI.nd[7,1]

CI.dc <- confint(lmer(sIdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.non.dc.sp$upr[7] <- CI.dc[6,2]
line.range.plot.non.dc.sp$upr[8] <- CI.dc[10,2] + CI.dc[6,2]
line.range.plot.non.dc.sp$upr[9] <- CI.dc[11,2] + CI.dc[6,2]
line.range.plot.non.dc.sp$lwr[7] <- CI.dc[6,1]
line.range.plot.non.dc.sp$lwr[8] <- CI.dc[10,1] + CI.dc[6,1]
line.range.plot.non.dc.sp$lwr[9] <- CI.dc[11,1] + CI.dc[6,1]
...
CI.nd <- confint(lmer(slnM ~ pf.sp.BA.total * bin + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.non.nd.sp$upr[4] <- CI.nd[7,2]
line.range.plot.non.nd.sp$upr[5] <- CI.nd[10,2] + CI.nd[7,2]
line.range.plot.non.nd.sp$upr[6] <- CI.nd[11,2] + CI.nd[7,2]
line.range.plot.non.nd.sp$lwr[4] <- CI.nd[7,1]
line.range.plot.non.nd.sp$lwr[5] <- CI.nd[10,1] + CI.nd[7,1]
line.range.plot.non.nd.sp$lwr[6] <- CI.nd[11,1] + CI.nd[7,1]

CI.dc <- confint(lmer(slnMdc ~ pf.sp.BA.total * bin - 1 + (1|harvest/PSP/SP) + (1|Year), data = vmfr))
line.range.plot.non.dc.sp$upr[4] <- CI.dc[6,2]
line.range.plot.non.dc.sp$upr[5] <- CI.dc[10,2] + CI.dc[6,2]
line.range.plot.non.dc.sp$upr[6] <- CI.dc[11,2] + CI.dc[6,2]
line.range.plot.non.dc.sp$lwr[4] <- CI.dc[6,1]
line.range.plot.non.dc.sp$lwr[5] <- CI.dc[10,1] + CI.dc[6,1]
line.range.plot.non.dc.sp$lwr[6] <- CI.dc[11,1] + CI.dc[6,1]
...
mod.nd <- summary(lmer(slnP ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
...
mod.dc <- summary(lmer(slnPdc~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(slnP ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.fix.nd$upr[1] <- CI.nd[6,2]
line.range.plot.fix.nd$upr[2] <- CI.nd[9,2] + CI.nd[6,2]
line.range.plot.fix.nd$upr[3] <- CI.nd[10,2] + CI.nd[6,2]
line.range.plot.fix.nd$lwr[1] <- CI.nd[6,1]
line.range.plot.fix.nd$lwr[2] <- CI.nd[9,1] + CI.nd[6,1]
line.range.plot.fix.nd$lwr[3] <- CI.nd[10,1] + CI.nd[6,1]

CI.dc <- confint(lmer(slnPdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.fix.dc$upr[1] <- CI.dc[5,2]
line.range.plot.fix.dc$upr[2] <- CI.dc[9,2] + CI.dc[5,2]
line.range.plot.fix.dc$upr[3] <- CI.dc[10,2] + CI.dc[5,2]
line.range.plot.fix.dc$lwr[1] <- CI.dc[5,1]
line.range.plot.fix.dc$lwr[2] <- CI.dc[9,1] + CI.dc[5,1]
line.range.plot.fix.dc$lwr[3] <- CI.dc[10,1] + CI.dc[5,1]
...
mod.nd <- summary(lmer(sI ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
...
mod.dc <- summary(lmer(sIdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(sI ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.fix.nd$upr[7] <- CI.nd[6,2]
line.range.plot.fix.nd$upr[8] <- CI.nd[9,2] + CI.nd[6,2]
line.range.plot.fix.nd$upr[9] <- CI.nd[10,2] + CI.nd[6,2]
line.range.plot.fix.nd$lwr[7] <- CI.nd[6,1]
line.range.plot.fix.nd$lwr[8] <- CI.nd[9,1] + CI.nd[6,1]
line.range.plot.fix.nd$lwr[9] <- CI.nd[10,1] + CI.nd[6,1]

CI.dc <- confint(lmer(sIdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.fix.dc$upr[7] <- CI.dc[5,2]
line.range.plot.fix.dc$upr[8] <- CI.dc[9,2] + CI.dc[5,2]
line.range.plot.fix.dc$upr[9] <- CI.dc[10,2] + CI.dc[5,2]
line.range.plot.fix.dc$lwr[7] <- CI.dc[5,1]
line.range.plot.fix.dc$lwr[8] <- CI.dc[9,1] + CI.dc[5,1]
line.range.plot.fix.dc$lwr[9] <- CI.dc[10,1] + CI.dc[5,1]


line.range.plot.fix.nd$sig[7] <- 0
...
mod.nd <- summary(lmer(slnM ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
...
mod.dc <- summary(lmer(slnMdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(slnM ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.fix.nd$upr[4] <- CI.nd[6,2]
line.range.plot.fix.nd$upr[5] <- CI.nd[9,2] + CI.nd[6,2]
line.range.plot.fix.nd$upr[6] <- CI.nd[10,2] + CI.nd[6,2]
line.range.plot.fix.nd$lwr[4] <- CI.nd[6,1]
line.range.plot.fix.nd$lwr[5] <- CI.nd[9,1] + CI.nd[6,1]
line.range.plot.fix.nd$lwr[6] <- CI.nd[10,1] + CI.nd[6,1]

CI.dc <- confint(lmer(slnMdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.fix.dc$upr[4] <- CI.dc[5,2]
line.range.plot.fix.dc$upr[5] <- CI.dc[9,2] + CI.dc[5,2]
line.range.plot.fix.dc$upr[6] <- CI.dc[10,2] + CI.dc[5,2]
line.range.plot.fix.dc$lwr[4] <- CI.dc[5,1]
line.range.plot.fix.dc$lwr[5] <- CI.dc[9,1] + CI.dc[5,1]
line.range.plot.fix.dc$lwr[6] <- CI.dc[10,1] + CI.dc[5,1]
...
mod.nd <- summary(lmer(slnP ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
...
CI.nd <- confint(lmer(slnP ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.non.nd$upr[1] <- CI.nd[6,2]
line.range.plot.non.nd$upr[2] <- CI.nd[9,2] + CI.nd[6,2]
line.range.plot.non.nd$upr[3] <- CI.nd[10,2] + CI.nd[6,2]
line.range.plot.non.nd$lwr[1] <- CI.nd[6,1]
line.range.plot.non.nd$lwr[2] <- CI.nd[9,1] + CI.nd[6,1]
line.range.plot.non.nd$lwr[3] <- CI.nd[10,1] + CI.nd[6,1]

CI.dc <- confint(lmer(slnPdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.non.dc$upr[1] <- CI.dc[5,2]
line.range.plot.non.dc$upr[2] <- CI.dc[9,2] + CI.dc[5,2]
line.range.plot.non.dc$upr[3] <- CI.dc[10,2] + CI.dc[5,2]
line.range.plot.non.dc$lwr[1] <- CI.dc[5,1]
line.range.plot.non.dc$lwr[2] <- CI.dc[9,1] + CI.dc[5,1]
line.range.plot.non.dc$lwr[3] <- CI.dc[10,1] + CI.dc[5,1]
...
CI.nd <- confint(lmer(sI ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.non.nd$upr[7] <- CI.nd[6,2]
line.range.plot.non.nd$upr[8] <- CI.nd[9,2] + CI.nd[6,2]
line.range.plot.non.nd$upr[9] <- CI.nd[10,2] + CI.nd[6,2]
line.range.plot.non.nd$lwr[7] <- CI.nd[6,1]
line.range.plot.non.nd$lwr[8] <- CI.nd[9,1] + CI.nd[6,1]
line.range.plot.non.nd$lwr[9] <- CI.nd[10,1] + CI.nd[6,1]

CI.dc <- confint(lmer(sIdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.non.dc$upr[7] <- CI.dc[5,2]
line.range.plot.non.dc$upr[8] <- CI.dc[9,2] + CI.dc[5,2]
line.range.plot.non.dc$upr[9] <- CI.dc[10,2] + CI.dc[5,2]
line.range.plot.non.dc$lwr[7] <- CI.dc[5,1]
line.range.plot.non.dc$lwr[8] <- CI.dc[9,1] + CI.dc[5,1]
line.range.plot.non.dc$lwr[9] <- CI.dc[10,1] + CI.dc[5,1]
...
CI.nd <- confint(lmer(slnM ~ pf.BA.total * bin + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.non.nd$upr[4] <- CI.nd[6,2]
line.range.plot.non.nd$upr[5] <- CI.nd[9,2] + CI.nd[6,2]
line.range.plot.non.nd$upr[6] <- CI.nd[10,2] + CI.nd[6,2]
line.range.plot.non.nd$lwr[4] <- CI.nd[6,1]
line.range.plot.non.nd$lwr[5] <- CI.nd[9,1] + CI.nd[6,1]
line.range.plot.non.nd$lwr[6] <- CI.nd[10,1] + CI.nd[6,1]

CI.dc <- confint(lmer(slnMdc ~ pf.BA.total * bin - 1 + (1|harvest/PSP) + (1|Year), data = vmfr))
line.range.plot.non.dc$upr[4] <- CI.dc[5,2]
line.range.plot.non.dc$upr[5] <- CI.dc[9,2] + CI.dc[5,2]
line.range.plot.non.dc$upr[6] <- CI.dc[10,2] + CI.dc[5,2]
line.range.plot.non.dc$lwr[4] <- CI.dc[5,1]
line.range.plot.non.dc$lwr[5] <- CI.dc[9,1] + CI.dc[5,1]
line.range.plot.non.dc$lwr[6] <- CI.dc[10,1] + CI.dc[5,1]
...
figure(
     ...
     path.name = 'c:/users/bryce/OneDrive/Documents/VMFR/Dynamics Paper 2019/Figures/LinePlot_combined.tif',
     width = 14, height = 10,
     save = T
)
